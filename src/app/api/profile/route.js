...
export async function PUT(req) {
  ...
  const { name, phone, academic_level, matric_marks, intermediate_marks, test_score, interests } = body;
  ...
  await query(
    `INSERT INTO students (user_id, phone, academic_level, matric_marks, intermediate_marks, test_score, interests, created_at, updated_at)
