export const admissionFormSections = [
  {
    ...
    fields: [
      ...
      { id: 'fatherOccupation',  label: "Father's Occupation",               type: 'text',     placeholder: 'e.g. Engineer, Businessman',      required: false },
      { id: 'guardianName',      label: 'Guardian Name (if not father)',      type: 'text',     placeholder: 'Leave blank if father is guardian', required: false },
      { id: 'guardianPhone',     label: 'Guardian Contact Number',           type: 'tel',      placeholder: '03XX-XXXXXXX',                    required: false },
      ...
      { id: 'address',           label: 'Permanent Address',                 type: 'textarea', placeholder: 'House No., Street, City',         required: true,  rows: 2, span: true },
      { id: 'mailingAddress',    label: 'Mailing Address (if different)',    type: 'textarea', placeholder: 'Leave blank if same as above',    required: false, rows: 2, span: true },
    ],
  },
  {
    id: 'academic',
    ...
    fields: [
      { id: 'schoolName',     label: 'School Name',               type: 'text',   placeholder: 'e.g. Government High School, Lahore', required: false, span: true },
      ...
      { id: 'collegeName',    label: 'College Name',              type: 'text',   placeholder: 'e.g. Punjab College, Lahore', required: false, span: true },
